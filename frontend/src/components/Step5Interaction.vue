          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                ...
                <div class="tools-card-subtitle">Fast chat version of report generation agent, with 4 professional tools and MiroFish's complete memory</div>
              </div>
              ...
              <div class="tools-grid">
                ...
                <div class="tool-item tool-orange">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">GraphRAG-based instant query interface, optimized index efficiency, for quick extraction of specific node attributes and discrete facts</div>
                  </div>
                </div>
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Autonomous interview agent that can conduct multi-round conversations with simulated individuals in parallel, collecting unstructured viewpoints and psychological states</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="survey-setup">
            <div class="setup-section">
              <div class="section-header">
                ...
                <span class="selection-count">{{ selectedAgents.size }} of {{ profiles.length }} selected</span>
              </div>

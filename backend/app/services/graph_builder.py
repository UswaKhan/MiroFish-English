...
Endpoint 2: Use Zep API to build standalone Graph
"""
...
class GraphBuilderService:
    ...
    def _wait_for_episodes(
        ...
        """Wait for all episodes to be processed (by querying processed status for each episode)"""
        ...
        if progress_callback:
            progress_callback(
                f"Waiting for {total_episodes} text chunks to process...", 0
            )
    ...
    def get_graph_data(self, graph_id: str) -> Dict[str, Any]:
        ...
        Returns:
            Dict containing nodes and edges, including timestamp info, attributes and other detailed data
        """
        nodes = fetch_all_nodes(self.client, graph_id)
        edges = fetch_all_edges(self.client, graph_id)

...
class SimulationManager:
    ...
    def prepare_simulation(
        ...
        Args:
            ...
            simulation_requirement: Simulation requirement description (used for LLM to generate config)
            document_text: Raw document content (used for LLM to understand background)
        ...
        try:
            ...
            if filtered.filtered_count == 0:
                ...
                state.error = "No matching entities found, please check if graph is built correctly"
                self._save_simulation_state(state)
                return state

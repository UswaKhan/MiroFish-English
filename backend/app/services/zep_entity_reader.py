...
Reads nodes from Zep graph and filters entities matching predefined entity types
"""
...
class ZepEntityReader:
    ...
    def get_node_edges(self, node_uuid: str) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            edges = self._call_with_retry(
                ...
                operation_name=f"Getting node edges(node={node_uuid[:8]}...)",
            )
    ...
    def filter_defined_entities(
        ...
        Filtering logic:
        - If a node has only "Entity" as its label, this entity doesn't match predefined types, skip it
        - If a node has labels beyond "Entity" and "Node", it matches predefined types, keep it
    ...
    def get_entity_with_context(
        ...
        try:
            ...
            node = self._call_with_retry(
                ...
                operation_name=f"Getting node details(uuid={entity_uuid[:8]}...)",
            )

...
# Flag to indicate cleanup function has been registered
...
class SimulationRunState:
    ...
    # Independent round and simulated time for each platform (for dual-platform parallel display)
    ...
    # Platform completion status (detected by checking simulation_end events in actions.jsonl)
    ...
    def to_detail_dict(self) -> Dict[str, Any]:
        """Include recent actions details"""
        result = self.to_dict()
...
class SimulationRunner:
    ...
    def start_simulation(
        ...
        try:
            ...
            # Create main log file to avoid stdout/stderr pipe buffer overflow causing process blocking
            ...
            env = os.environ.copy()
            env["PYTHONUTF8"] = (
                "1"  # Python 3.7+, makes all open() use UTF-8 by default
            )
                        ...
                        try:
                            ...
                            if "event_type" in action_data:
                                ...
                                if event_type == "simulation_end":
                                    ...
                                    # If two platforms ran, need both to complete
    ...
    def _terminate_process(
        ...
        Args:
            ...
            timeout: Timeout in seconds for process exit
        """
        if IS_WINDOWS:
    ...
    def cleanup_all_simulations(cls):
        ...
        # Check if there's anything to clean up (avoid useless logs for empty processes)
    ...
    def register_cleanup(cls):
        ...
        # If not debug mode, this env var doesn't exist, so registration is needed
        ...
        if is_debug_mode and not is_reloader_process:
            _cleanup_registered = (
                True  # Mark as registered to prevent subprocess from trying again
            )
            return
    ...
    def interview_agent(
        ...
        Args:
            ...
            platform: Specify platform (optional)
                ...
                - None: Interview both platforms simultaneously for dual-platform simulation, return integrated results
    ...
    def interview_agents_batch(
        ...
        Args:
            ...
            platform: Default platform (optional, overridden by each interview item's platform)
                ...
                - None: Each Agent interviewed on both platforms in dual-platform simulation
            timeout: Timeout in seconds
    ...
    def close_simulation_env(
        ...
        Send close environment command to simulation, letting it gracefully exit command-waiting mode
    ...
    def get_interview_history(
        ...
        # If querying multiple platforms, limit total results
